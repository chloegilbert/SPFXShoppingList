...
export default class ShoppingList extends React.Component<IShoppingListProps, {}> {
  constructor(props: IShoppingListProps) {
    super(props);
    // set initial state
    this.state = { Title: "", SpinnerClass: "", SpinnerType: fabric.SpinnerType.large, SpinnerVisible: true, PanelVisible: false, ButtonClass: "ms-Button--primary", Lists: [], Items: [] };
  }
  ...
  private renderItems(): JSX.Element {
    if (this.props.showItems) return (
      <div>
        <h2>The list '{this.props.listName}' contains the following items: </h2>
